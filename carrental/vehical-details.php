...
if(isset($_POST['submit'])) {
  ...
  if($query1->rowCount() == 0) {
    ...
    if($lastInsertId) {
      echo "<script>alert('Đặt lịch xem xe thành công.');</script>";
    ...
    echo "<script>alert('Xe đã được đặt lịch xem!');</script>";
    echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
  }
...
<head>
  ...
  <title>TTV Car | Chi tiết về xe</title>
  <!--Bootstrap -->
                ...
                <div class="listing_detail_wrap">
                  ...
                  <ul class="nav nav-tabs gray-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview"
                        role="tab" data-toggle="tab">Tổng quan về xe </a></li>
        ...
        <aside class="col-md-3">
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-envelope" aria-hidden="true"></i>Đặt lịch ngay</h5>
            </div>
            <form method="post">
              ...
              <?php if($_SESSION['login']) { ?>
                <div class="form-group">
                  <input type="submit" class="btn" name="submit" value="Đặt lịch ngay">
                </div>
              <?php } else { ?>
                <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Đăng nhập để
                  đặt lịch xem xe</a>
