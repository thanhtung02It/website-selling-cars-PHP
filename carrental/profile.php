...
if (strlen($_SESSION['login']) == 0) {
  ...
  <head>
    ...
    <title>TTV Car| Hồ sơ của tôi</title>
    <!--Bootstrap -->
      ...
      <div class="container">
        <div class="page-header_wrap">
          <div class="page-heading">
            <h1>Hồ sơ của bạn</h1Your Profile>
          </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="profile_wrap">
                    ...
                    <form method="post">
                      ...
                      <?php if ($result->UpdationDate != "") { ?>
                        <div class="form-group">
                          <label class="control-label">Cập nhật lần cuối lúc -</label>
                  ...
                  <div class="form-group">
                    <button type="submit" name="updateprofile" class="btn">Lưu thay đổi <span class="angle_arrow"><i
