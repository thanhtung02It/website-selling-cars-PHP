...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> xe được tìm thấy !</span></p>
</div>
</div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Tìm kiếm xe mà bạn muốn </h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo htmlentities(number_format($result->PricePerDay, 0, ',', '.')); ?>VND</p>
                </div>
              </li>
              <?php }} ?>
