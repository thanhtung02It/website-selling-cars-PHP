    ...
    <div class="container">
      <div class="page-header_wrap">
        <div class="page-heading">
          <h1>Tìm kiếm kết quả từ khóa "
            <?php echo $_POST['searchdata']; ?>"
          </h1>
        </div>
        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
             ...
             $searchTerm = "%" . $searchdata . "%"; // Thêm dấu % cho tìm kiếm mô phỏng LIKE
              ...
              ?>
              <p><span>
                  <?php echo htmlentities($cnt); ?> kết quả tìm kiếm cho từ khóa trên !
                </span></p>
            </div>
          </div>
            ...
            foreach ($results as $result) { ?>
              <div class="product-listing-m gray-bg">
                ...
                <div class="product-listing-content">
                  ...
                  <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn">Xem chi tiết<span
...
<?php }
              ...
              <div class="form-group select">
                ...
                <div class="sidebar_widget">
                  <div class="widget_heading">
                    <h5><i class="fa fa-car" aria-hidden="true"></i> Danh sách xe tìm kiếm gần đây</h5>
                  </div>
