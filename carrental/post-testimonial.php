...
if (strlen($_SESSION['login']) == 0) {
  ...
  <head>
    ...
    <title>TTV Car|Gửi đánh giá</title>
    <!--Bootstrap -->
          ...
          <div class="col-md-3 col-sm-3">
            ...
            <div class="col-md-6 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">Gửi đánh giá</h5>
                <?php if ($error) { ?>
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    <label class="control-label">Lời đánh giá</label>
                    <textarea class="form-control white_bg" name="testimonial" rows="4" required=""></textarea>
                  </div>


                  <div class="form-group">
                    <button type="submit" name="submit" class="btn">Lưu <span class="angle_arrow"><i
