...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TTV Car | Quản Trị Cập Nhật Hình Ảnh 2</title>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Hình ảnh chi tiết xe 2</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Hình ảnh hiện tại 2</label>
													<?php
													$id = intval($_GET['imgid']);
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Tải lên hình ảnh mới 2<span
