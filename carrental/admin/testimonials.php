...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['eid'])) {
		...
		$msg = "Đánh giá không được phê duyệt ";
	}
	...
	<head>
		...
		<title>TTV Car |Quản trị viên Quản lý nhận xét của khách hàng </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Quản lý đánh giá của khách hàng</h2>

							<!-- Zero Configuration Table -->
							<div class="panel panel-default">
								<div class="panel-heading">Đánh giá của khách hàng</div>
														...
														<td>
															<?php if ($result->status == "" || $result->status == 0) {
																?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn phê duyệt')">Chờ phê
																	duyệt</a>
															<?php } else { ?>

																<a href="testimonials.php?eid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn vô hiệu hoá')"> Phê
																	duyệt
																</a>
															</td>
														<?php } ?>
