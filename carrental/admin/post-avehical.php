...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TTV Car | Quản trị viên đăng xe</title>
					...
					<div class="row">
						<div class="col-md-12">
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												<div class="form-group">
													<label class="col-sm-2 control-label">Tên xe<span
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Giá<span
															style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													<div class="col-sm-4">
														Hình ảnh 1 <span style="color:red">*</span><input type="file"
															name="img1" required>
													</div>
													<div class="col-sm-4">
														Hình ảnh 2<span style="color:red">*</span><input type="file"
															name="img2" required>
													</div>
													<div class="col-sm-4">
														Hình ảnh 3<span style="color:red">*</span><input type="file"
															name="img3" required>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-4">
														Hình ảnh 4<span style="color:red">*</span><input type="file"
															name="img4" required>
													</div>
													<div class="col-sm-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Hệ thống của xe</div>
										<div class="panel-body">
												...
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="airconditioner" name="airconditioner"
															value="1">
														<label for="airconditioner"> Hệ thống điều hòa </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="powerdoorlocks" name="powerdoorlocks"
															value="1">
														<label for="powerdoorlocks"> Cửa trợ lực </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="antilockbrakingsys">Hệ thống phanh an toàn </label>
													</div>
												</div>
												<div class="checkbox checkbox-inline">
												...
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="passengerairbag" name="passengerairbag"
															value="1">
														<label for="passengerairbag"> Túi khí ghế phụ</label>
													</div>
												</div>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
													<label for="powerwindow"> Đóng của kính tự động </label>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="cdplayer"> Máy nghe đĩa CD </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox h checkbox-inline">
														<input type="checkbox" id="centrallocking" name="centrallocking"
															value="1">
														<label for="centrallocking">Tự động khoá tất cả cửa xe</label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
												...
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="leatherseats" name="leatherseats"
															value="1">
														<label for="leatherseats"> Ghế da xịn</label>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<button class="btn btn-default" type="reset">Đóng</button>
													<button class="btn btn-primary" name="submit" type="submit">Lưu thay
														đổi</button>
												</div>
											</div>
