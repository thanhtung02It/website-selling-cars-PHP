...
if(strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TTV Car | Quản trị viên Tạo thương hiệu</title>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" name="chngpwd" class="form-horizontal"
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
															...
															<option value="manage-pages.php?type=privacy">Quyền riêng tư và
																chính sách</option>
															<option value="manage-pages.php?type=aboutus">Về chúng tôi
															</option>
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Đã chọn trang</label>
													<div class="col-sm-8">
														<?php
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="5" cols="50" name="pgedetails"
															id="pgedetails" placeholder="Chi tiết gói" required>
																								<?php
																								$pagetype = $_GET['type'];
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														...
														<button type="submit" name="submit" value="Update" id="submit"
															class="btn-primary btn">Cập nhật</button>
													</div>
												</div>
