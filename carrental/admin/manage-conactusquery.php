...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TTV Car |Quản trị viên quản lý liên lạc </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Quản lý liên hệ với chúng tôi</h2>

							<!-- Zero Configuration Table -->
							<div class="panel panel-default">
								<div class="panel-heading">Truy vấn của người dùng</div>
													...
													<tr>
														...
														<?php } else { ?>
															...
															<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn đọc ?')">Đọc</a>
															</td>
														<?php } ?>
													</tr>
													<?php $cnt = $cnt + 1;
