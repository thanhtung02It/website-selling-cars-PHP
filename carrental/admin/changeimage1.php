...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TTV Car | Quản Trị Cập Nhật Hình Ảnh 1</title>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Hình ảnh xe 1 chi tiết</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Hình ảnh hiện tại 1</label>
													<?php
													$id = intval($_GET['imgid']);
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Tải lên hình ảnh mới 1<span
