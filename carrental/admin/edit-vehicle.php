...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$msg = "Dữ liệu được cập nhật thành công!";
	...
	<head>
		...
		<title>TTV Car | Quản trị Chỉnh sửa thông tin xe</title>
												...
												foreach ($results as $result) { ?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														<div class="form-group">
															<label class="col-sm-2 control-label">Tiêu đề xe<span
															...
															<label class="col-sm-2 control-label">Chọn thương hiệu<span
																	style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Tổng quan về xe <span
																	style="color:red">*</span></label>
															<div class="col-sm-10">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Giá xe<span
																	style="color:red">*</span></label>
															<div class="col-sm-4">
															...
															<label class="col-sm-2 control-label">Chọn loại nhiên liệu<span
																	style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Năm sản xuất<span
																	style="color:red">*</span></label>
															<div class="col-sm-4">
															...
															<label class="col-sm-2 control-label">Số chỗ ngồi<span
																	style="color:red">*</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															<div class="col-sm-4">
																...
																<a
																	href="changeimage1.php?imgid=<?php echo htmlentities($result->id) ?>">Đổi
																	hình ảnh xe 1</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 2<img
																	...
																	width="300" height="200" style="border:solid 1px #000">
																<a
																	href="changeimage2.php?imgid=<?php echo htmlentities($result->id) ?>">Đổi
																	hình ảnh xe 2</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 3<img
																	...
																	width="300" height="200" style="border:solid 1px #000">
																<a
																	href="changeimage3.php?imgid=<?php echo htmlentities($result->id) ?>">Đổi
																	hình ảnh xe 3</a>
															</div>
														</div>
														...
														<div class="form-group">
															<div class="col-sm-4">
																Hình ảnh 4<img
																	...
																	width="300" height="200" style="border:solid 1px #000">
																<a
																	href="changeimage4.php?imgid=<?php echo htmlentities($result->id) ?>">Đổi
																	hình ảnh xe 4</a>
															</div>
															<div class="col-sm-4">
																Hình ảnh 5
																<?php if ($result->Vimage5 == "") {
																	...
																	<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5); ?>"
																		width="300" height="200" style="border:solid 1px #000">
																	<a
																		href="changeimage5.php?imgid=<?php echo htmlentities($result->id) ?>">Đổi
																		hình ảnh xe 5</a>
																<?php } ?>
															</div>
															...
															<?php if ($result->AirConditioner == 1) { ?>
																<div class="checkbox checkbox-inline">
																	<input type="checkbox" id="inlineCheckbox1" name="airconditioner"
																		checked value="1">
																	<label for="inlineCheckbox1"> Máy điều hòa </label>
																</div>
															<?php } else { ?>
																<div class="checkbox checkbox-inline">
																	<input type="checkbox" id="inlineCheckbox1" name="airconditioner"
														...
														<div class="col-sm-3">
															<?php if ($result->AntiLockBrakingSystem == 1) { ?>
																<div class="checkbox checkbox-inline">
																	...
																	<label for="inlineCheckbox3"> Hệ thống phanh chống bó cứng</label>
																</div>
															<?php } else { ?>
																<div class="checkbox checkbox-inline">
																	<input type="checkbox" id="inlineCheckbox1"
																...
																<div class="col-sm-3">
																	<div class="checkbox checkbox-inline">
																		<input type="checkbox" id="inlineCheckbox1" name="powersteering"
																			checked value="1">
																		<label for="inlineCheckbox1"> Hệ thống lái trợ lực</label>
																	</div>
																<?php } else { ?>
																	<div class="col-sm-3">
																		<div class="checkbox checkbox-inline">
																...
																<div class="col-sm-3">
																	<?php if ($result->DriverAirbag == 1) {
																		...
																		<div class="checkbox checkbox-inline">
																			...
																			<label for="inlineCheckbox2">Tay lái trợ lực</label>
																		</div>
																	<?php } else { ?>
																		<div class="checkbox checkbox-inline">
																			<input type="checkbox" id="inlineCheckbox1"
																...
																<div class="col-sm-3">
																	<?php if ($result->DriverAirbag == 1) {
																		...
																		<div class="checkbox checkbox-inline">
																			...
																			<label for="inlineCheckbox3"> Túi khí dự trữ </label>
																		</div>
																	<?php } else { ?>
																		<div class="checkbox checkbox-inline">
																			<input type="checkbox" id="inlineCheckbox1"
																...
																<div class="col-sm-3">
																	<?php if ($result->PowerWindows == 1) {
																		...
																		<div class="checkbox checkbox-inline">
																			...
																			<label for="inlineCheckbox3"> Cửa xe trợ lực </label>
																		</div>
																	<?php } else { ?>
																		<div class="checkbox checkbox-inline">
																			<input type="checkbox" id="inlineCheckbox1"
																	...
																	<div class="col-sm-3">
																		<?php if ($result->CDPlayer == 1) {
																			...
																			<div class="checkbox checkbox-inline">
																				...
																				<label for="inlineCheckbox1"> Máy nghe đĩa CD
																				</label>
																			</div>
																		<?php } else { ?>
																			<div class="checkbox checkbox-inline">
																	...
																	<div class="col-sm-3">
																		<?php if ($result->CrashSensor == 1) {
																			...
																			<div class="checkbox checkbox-inline">
																				...
																				<label for="inlineCheckbox3"> Cảm biến va chạm
																				</label>
																			</div>
																		<?php } else { ?>
																			<div class="checkbox checkbox-inline">
