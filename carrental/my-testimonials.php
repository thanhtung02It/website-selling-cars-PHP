...
if (strlen($_SESSION['login']) == 0) {
  ...
  <head>
    ...
    <title>TTV Car| Đánh giá của tôi </title>
    <!--Bootstrap -->
          ...
          <div class="col-md-3 col-sm-3">
            ...
            <div class="col-md-8 col-sm-8">
              ...
              <div class="profile_wrap">
                <h5 class="uppercase underline">Đánh giá của tôi</h5>
                      ...
                      foreach ($results as $result) { ?>
                        ...
                        <li>
                          ...
                          <?php if ($result->status == 1) { ?>
                            <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Phê duyệt</a>

                              <div class="clearfix"></div>
                            </div>
                          <?php } else { ?>
                            <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Chờ phê duyệt</a>
                              <div class="clearfix"></div>
                            </div>
                          <?php } ?>
                        </li>
