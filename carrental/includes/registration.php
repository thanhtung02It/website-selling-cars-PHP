  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              <form method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Số điện thoại" maxlength="10"
                    required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">Tôi đồng ý <a href="#">Các điều khoản và điều kiện</a></label>
                </div>
                <div class="form-group">
      ...
      <div class="modal-footer text-center">
        <p>Bạn đã có tài khoản chưa? <a href="#loginform" data-toggle="modal" data-dismiss="modal">Đăng nhập tại đây</a>
        </p>
      </div>
    </div>
  </div>
