...
if (isset($_POST['update'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    echo "<script>alert(' Email hoặc Số di động không hợp lệ');</script>";
  }
}
          ...
          <div class="forgotpassword_wrap">
            <div class="col-md-12">
              <form name="chngpwd" method="post" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Số điện thoại bạn đăng ký"
                    required="">
                </div>
                <div class="form-group">
