...
if (isset($_POST['send'])) {
  ...
  if ($lastInsertId) {
    $msg = "Thông tin đã được gửi. Chúng tôi sẽ sớm liên lạc lại với bạn";
  } else {
...
<head>
  ...
  <title>TTV Car | Liên lạc với chúng tôi</title>
  <!--Bootstrap -->
  ...
  <<!-- Start Switcher -->
    ...
    <section class="contact_us section-padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3>Hãy liên lạc bằng cách sử dụng biểu mẫu dưới đây:</h3>
            <?php if ($error) { ?>
            ...
            <div class="contact_form gray-bg">
              <form method="post">
                ...
                <div class="form-group">
                  <button class="btn" type="submit" name="send" type="submit">Gửi tin nhắn <span class="angle_arrow"><i
              ...
              if ($query->rowCount() > 0) {
                foreach ($results as $result) { ?>
                  <ul>
                    <li>
                      <div class="icon_wrap">
                        <a href="https://maps.google.com/?q=<?php echo urlencode($result->Address); ?>" target="_blank">
                    ...
                    <li>
                      ...
                      <div class="contact_info_m"><a href="ndtung2002@gmail.com">
