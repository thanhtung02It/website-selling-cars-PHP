  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        <h2>Tìm xe tốt nhất phù hợp dành cho bạn<span></span></h2>
        <p>Tại đây, chúng ta có thể tìm thấy một loạt các lựa chọn từ các hãng xe uy tín và đa dạng về kiểu dáng, kích
          thước, cũng như công nghệ tích hợp. Tùy thuộc vào sở thích cá nhân, bạn có thể quan tâm đến các tính năng như
          động cơ mạnh mẽ, tiết kiệm nhiên liệu, hoặc các tính năng an toàn như hệ thống phanh tự động hay cảm biến va
          chạm.</p>
      </div>
      <div class="row">
        ...
        <div class="recent-tab">
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Những mẫu xe
                mới</a></li>
          </ul>
        </div>
  ...
  <section class="section-padding testimonial-section parallex-bg">
    <div class="container div_zindex">
      <div class="section-header white-text text-center">
        <h2>Phản hồi khách hàng<span></span></h2>
      </div>
      <div class="row">
